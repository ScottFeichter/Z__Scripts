...
# Here's a simple example of a Node.js backend application using TypeScript: [1]
...
# [1] https://dev.to/sulistef/how-to-set-up-a-nodejs-backend-using-expressjs-and-typescript-1655[-] https://docs.aws.amazon.com/amplify/latest/userguide/deploy-express-server.html
