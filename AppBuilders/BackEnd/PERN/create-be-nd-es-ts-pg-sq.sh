...
# 8. Create a database configuration file:
mkdir src/config
...
# 9. Create database, models, migrations, seeders directories
mkdir src/database src/database/models src/database/migrations src/database/seeders
