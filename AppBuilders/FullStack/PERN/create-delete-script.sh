...
APP_PROJECT_DIR_NAME=test


# Variables
vpc_id="pretend-vpc"
BUCKET_NAME="pretend-s3"
DB_IDENTIFIER="pretend-db"
APP_ID="pretend-app-id"
PG_DB_NAME="pretend--pg-db-name"
ADMIEND_REPO_NAME="pretend-admiend"
FRONTEND_REPO_NAME="pretend-frontend"
BACKEND_REPO_NAME="pretend-backend"
